    ...
    <>
      ...
      <InformationPanel isOpen={isOpen && !!ad}>
        ...
        <InformationPanelBody>
          ...
          <InformationPanelContent>
            {ad?.vision.fullTextAnnotation.pages?.map((page, pageIndex) => {
              return (
          ...
          <InformationPanelContent>
            ...
            <div style={{ display: "flex", gap: 4, flexDirection: "column" }}>
              ...
              <div>Medical: {ad?.vision.safeSearchAnnotation.medical}</div>
              <div>Racy: {ad?.vision.safeSearchAnnotation.racy}</div>
              <div>Spoof: {ad?.vision.safeSearchAnnotation.spoof}</div>
              <div>Violence: {ad?.vision.safeSearchAnnotation.violence}</div>
            </div>
          </InformationPanelContent>
        </InformationPanelBody>
      </InformationPanel>
